...
var disks = require("../main/client/disks")
...
/**
 * old tests that seem overly complicated to perform leaving here for reference
 * puposes.  TODO: move to some TDD/Acceptance testing example
 *
 *   var diskData = [
